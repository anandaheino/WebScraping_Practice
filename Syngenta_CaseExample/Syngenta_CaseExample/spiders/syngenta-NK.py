...
class SyngentaSpider(scrapy.Spider):
    ...
    scrap = abre_e_scrap('https://www.portalsyngenta.com.br/sementes/nk-soja')
    ...
    def parse(self, response):
        ...
        item['pubescencia'] = response.xpath('//div[@class="prop-nk-descricao"]/p/text()').extract()[3]
        item['acamamento'] = response.xpath('//div[@class="prop-nk-descricao"]/p/text()').extract()[4]
        item['hilo'] = response.xpath('//div[@class="prop-nk-descricao"]/p/text()').extract()[5]
        item['altura_planta'] = response.xpath('//div[@class="prop-nk-descricao"]/p/text()').extract()[6]
        item['pms_medio'] = response.xpath('//div[@class="prop-nk-descricao"]/p/text()').extract()[7]
        item['insercao_vagem'] = response.xpath('//div[@class="prop-nk-descricao"]/p/text()').extract()[8]
